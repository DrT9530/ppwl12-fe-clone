  ...
  return (
    <section className="relative min-h-[700px] md:min-h-[750px] flex items-center justify-center">
      ...
      <div className="relative z-10 text-center px-4 max-w-3xl mx-auto pt-20 md:pt-24">
        ...
        <p className="text-lg md:text-xl text-white/90 mt-2 mb-8 font-bold">
        ...
        <div className="flex flex-col md:flex-row gap-3 justify-center items-center max-w-2xl mx-auto">
          <div className="relative w-full md:w-auto md:flex-1">
            <input
              ...
              className="w-full bg-black/60 border border-white/30 text-white px-4 py-3 rounded placeholder-white/50 focus:outline-none focus:border-white transition-colors h-12 md:h-14 text-base md:text-lg"
            />
          </div>
          
          <button className="w-full md:w-auto bg-[#e50914] hover:bg-[#f40612] text-white text-xl md:text-2xl font-semibold px-8 rounded flex items-center justify-center gap-2 transition-colors h-12 md:h-14">
            Get Started
