...
function CategoryIcon({ type }: { type: string }) {
  switch (type) {
    case 'film':
      return (
        <svg className="title-grid-cat-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor">
    ...
    case 'game':
      return (
        <svg className="title-grid-cat-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor">
          ...
          <path d="M17.32 5H6.68a4 4 0 0 0-3.978 3.59c-.006.052-.01.101-.017.152C2.604 9.416 2 14.456 2 16a3 3 0 0 0 3 3c1.392 0 1.943-.5 2.5-1.5l1.414-2.121A2 2 0 0 1 10.586 15h2.828a2 2 0 0 1 1.672.879L16.5 18c.557 1 1.108 1.5 2.5 1.5a3 3 0 0 0 3-3c0-1.545-.604-6.584-.685-7.258-.007-.05-.011-.1-.017-.151A4 4 0 0 0 17.32 5z" strokeWidth="2"/>
        </svg>
      );
    default:
      return null;
    ...
    <section className="title-grid-section">
      <div className="title-grid-container">
        ...
        <div className="title-grid-more-wrapper">
          <button className="title-grid-more-btn">
